---
title: "R Tutorial for Commuting Information with IPUMS USA"
author: Nathan Anderson-Hobbs
date: March 22, 2005
...
Next, you will need to retrieve the data file from the IPUMS USA website. 
...
We can now interpret the results. Each index is plotted into a different corner of the cell. Shaded areas approaching the outside of the cell represent higher values in that category. For example, here we see that people in the "Bike/Walk/Other" category have higher values for biospheric and altruistic values (NOTE: These values do not reflect actual data). As a result, communications toward these groups should appeal to these sets of values.

Repeat the above steps for non-urban and mixed-use/suburban commuters to complete the full 9x9 matrix. 
